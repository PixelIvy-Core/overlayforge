...
OverlayForge is a small streaming overlay manager combining a FastAPI backend and a Vite + React frontend. It provides overlays and a simple local music player.
